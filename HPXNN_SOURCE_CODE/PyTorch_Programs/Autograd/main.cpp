...
int main() {
  ...
  hpx::cout << std::boolalpha;
	...
	hpx::future<void> f0 = hpx::async(basic_autograd_operations_example);

  hpx::cout << "\n";

	hpx::future<void> f1 = hpx::async(compute_higher_order_gradients_example);

  hpx::cout << "\n";

	hpx::future<void> f2 = hpx::async(custom_autograd_function_example);
  hpx::cout << "\n";
  hpx::cout << "\n";
auto stop = high_resolution_clock::now();
    ...
    hpx::cout << "Time taken by function: "
    << duration.count() << " microseconds" << hpx::endl;
}
